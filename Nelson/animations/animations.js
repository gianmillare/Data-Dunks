...
//   if(data[0]["3P"]>data[0]["2P"]){
  ...
  //   timeLine.to("#fThreePoint", {autoAlpha:1, visibility: "visible", duration: 2.1, x: 100})
  ...
  // } else {
    ...
    timeLine.to("#fLaunch", {autoAlpha:1, visibility: "visible", duration: 2.8, x: 100})
...
// } else {
  ...
  //   timeLine.to("#threePoint", {autoAlpha:1, visibility: "visible", duration: 2.1, x: -100})
...
//     timeLine.to("#launch", {autoAlpha:1, visibility: "visible", duration: 2.8, x: -100})
